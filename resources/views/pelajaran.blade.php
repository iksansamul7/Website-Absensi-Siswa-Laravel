        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="/pelajaran">Data Pelajaran</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container">
            ...
            <div class="row g-3 mt-2">
              <form class="row g-3 " action="/pelajaran" method="GET">
                @csrf
                <div class="col-auto">
                ...
                <div class="col-auto">
                    <a href="/tambahpelajaran" type="button"  class="btn btn-success">Tambah</a>
                  </div>   
                <div class="col-auto">
                    <a href="/pelajaranpdf" type="button"  class="btn btn-danger">PDF</a>
                  </div>        
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/tampilpelajaran/{{ $item->id }}"  class="btn btn-warning">Update</a>
                                {{-- dibawah adalah contoh delete yang menggunakan animasi jquery --}}
                                <a href="#" class="btn btn-danger delete" data-id="{{ $item->id }}" data-nama="{{ $item->namapelajaran }}" >Delete</a>
                            </td>
                          </tr>
                        @endforeach
...
<script>
   ...
   $('.delete').click(function(){
       var pelajaranid = $(this).attr('data-id');
       var pelajarannama = $(this).attr('data-nama');
       swal({
           title: "Apa kamu yakin ?",
           text: "Data yang akan dihapus adalah "+pelajarannama+"",
           icon: "warning",
           buttons: true,
           dangerMode: true,
       })
       ...
       if (willDelete) {
           //dibawah merupakan untuk memanggil fungsi menghapus dari route web.php
               window.location = "/deletepelajaran/"+pelajaranid+""
