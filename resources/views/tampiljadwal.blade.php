                      ...
                      <form action="/updatejadwal/{{ $data->id }}" method="post" enctype="multipart/form-data">
                          @csrf
                            ...
                            <div class="mb-3">
                              ...
                              <select class="form-select" name="pelajaran_id" aria-label="Default select example" required>
                            ...
                            <div class="mb-3">
                              ...
                              <input type="time" value="{{ $data->waktu}}" name="waktu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                              @error('waktu') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>
                            <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Jam ke</label>
                              <input type="number" value="{{ $data->jamke}}" name="jamke" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
