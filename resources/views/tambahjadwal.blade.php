            ...
            <div class="card">
                <div class="card-body">
                    <form action="/insertjadwal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Pilih Mata Pelajaran</label>
                          <select class="form-control" name="pelajaran_id" aria-label="Default select example" required>
                            <option selected>Pilih Mata Pelajaran</option>
                            @foreach ($datapelajaran as $item)
                            <option value="{{ $item->id }}">{{ $item->namapelajaran }}</option>
                            @endforeach
                          </select>
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Hari</label>
                          <select class="form-control" name="hari" aria-label="Default select example" required>
                        ...
                        <div class="mb-3">
                          <label for="exampleInputEmail1" class="form-label">Jam Mengajar</label>
                          <input type="time" name="waktu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                          @error('waktu') <div class="alert alert-danger">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputEmail1" class="form-label">Jam ke</label>
                          <input type="number" name="jamke" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                          @error('jamke') <div class="alert alert-danger">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-control" name="semester_id" aria-label="Default select example" required>
                            <option selected>Pilih Tahun Semester</option>
