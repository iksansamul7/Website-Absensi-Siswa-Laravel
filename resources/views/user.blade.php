        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="/kelas">Data User</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container">
            ...
            <div class="row g-3 mt-2 mb-3">
                <div class="col-auto">
                    <a href="/tambahuser" type="button"  class="btn btn-success">Tambah Data</a>
                  </div>        
            </div>
...
<script>
   ...
   $('.delete').click(function(){
       ...
       swal({
           ...
           text: "Data yang akan dihapus adalah "+nama+"",
           icon: "warning",
           buttons: true,
           dangerMode: true,
       })
