    ...
    <section class="content">
        ...
        <div class="container">
            ...
            <div class="row g-3 mt-2">
              <form class="row g-3 " action="/kelas" method="GET">
                @csrf
                <div class="col-auto">
                ...
                <div class="col-auto">
                    <a href="/tambahkelas" type="button"  class="btn btn-success">Tambah</a>
                  </div>   
                <div class="col-auto">
                    <a href="/kelaspdf" type="button"  class="btn btn-danger">PDF</a>
                  </div>        
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/tampilkelas/{{ $item->id }}"  class="btn btn-warning">Update</a>
                                {{-- dibawah adalah contoh delete yang menggunakan animasi jquery --}}
                                <a href="#" class="btn btn-danger delete" data-id="{{ $item->id }}" data-nama="{{ $item->namakelas }}" >Delete</a> 
                            </td>
                          </tr>
                        @endforeach
...
<script>
   ...
   $('.delete').click(function(){
       ...
       var kelasnama = $(this).attr('data-nama');
       swal({
           title: "Apa kamu yakin ?",
           text: "Data yang akan dihapus adalah "+kelasnama+"",
           icon: "warning",
           buttons: true,
           dangerMode: true,
       })
